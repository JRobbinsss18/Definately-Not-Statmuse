        ...
        if not players and not teams:
            ...
            for name in potential_names:
                ...
                if name_parts[0] in action_words:
                    ...
                    known_teams = {'Warriors', 'Lakers', 'Bulls', 'Celtics', 'Heat', 'Knicks', 'Nets', 'Sixers', 'Raptors', 'Magic', 'Hawks', 'Hornets', 'Pistons', 'Pacers', 'Cavaliers', 'Bucks', 'Timberwolves', 'Thunder', 'Blazers', 'Jazz', 'Nuggets', 'Clippers', 'Suns', 'Kings', 'Mavericks', 'Rockets', 'Grizzlies', 'Pelicans', 'Spurs'}
                    if name_parts[0] in known_teams:
                        continue
                    players.append(name)
